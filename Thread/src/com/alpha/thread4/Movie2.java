...
public class Movie2 implements Comparable , Serializable
{
	private String title;
	private int Ryear;
	
	public Movie2(String title, int Ryear) 
	{
		this.title = title;
		this.Ryear = Ryear;
	}
	...
	public void readtTitle(String fp) 
	{
		...
		@Override
			...
			{
			return	this.title.compareTo(((Movie2)o).title);
			}
